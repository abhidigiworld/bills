  ...
  useEffect(() => {
    const fetchInvoiceDetails = async () => {
      try {
        ...
        const total = subTotal + data.freightCharges;
        const cgst = (data.cgstPercent / 100) * subTotal;
        const sgst = (data.sgstPercent / 100) * subTotal;
        const igst = (data.igstPercent / 100) * subTotal;
