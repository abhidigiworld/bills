    ...
    return (
        <div className="flex flex-col min-h-screen bg-indigo-50 dark:bg-[#110f18] text-slate-800 dark:text-gray-200 transition-colors duration-300">
            ...
            <main className="flex-grow p-4 sm:p-6 md:p-8">
                <div className="max-w-3xl mx-auto bg-white dark:bg-[#181622] border border-slate-200 dark:border-[#262235] shadow-xl rounded-[2rem] p-6 sm:p-8 mb-10 transition-colors duration-300">
